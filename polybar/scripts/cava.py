...
def createCavaConfig():
    ...
    config.set('general', 'framerate', str(60))
    config.set('general', 'sensitivity', str(100))
#    config.set('general', 'lower_cutoff_freq', str(200))
#    config.set('general', 'higher_cutoff_freq', str(16000))
    ...
    config.set('smoothing', 'integral', '40')
    config.set('smoothing', 'monstercat', '1')
